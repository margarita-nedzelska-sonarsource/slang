...
import static org.sonarsource.kotlin_ng.plugin.TextRangeAssert.assertTextRange;
...
public class KotlinSensorTest extends AbstractSensorTest {
  ...
  private KotlinSensor sensor(CheckFactory checkFactory) {
    return new KotlinSensor(checkFactory, new NoSonarFilter(), fileLinesContextFactory, language());
  }
