...
import org.sonarsource.kotlin_ng.checks.TooManyParametersKotlinCheck;
import org.sonarsource.kotlin_ng.checks.UnusedPrivateMethodCheck;
...
public final class KotlinCheckList {
  ...
  public static List<Class<?>> checks() {
    return new ArrayList<>(KOTLIN_LANGUAGE_SPECIFIC_CHECKS);
  }
}
